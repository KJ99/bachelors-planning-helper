...
@Component
public class EstimationVotesManagementVoter extends BasePlanningEntityVoter<PlanningAction> {

    @Autowired
    protected EstimationVotesManagementVoter(MemberProvider memberProvider) {
    ...
    protected PlanningAction[] getSupportedActions() {
        return new PlanningAction[] {
                PlanningAction.CLEAR_VOTES,
                PlanningAction.FETCH_VOTES
        };
    }
